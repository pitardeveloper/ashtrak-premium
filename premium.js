...
// playing
client.on('ready', () => {
                                                                                                                                                                                                                                                                              client.user.setGame(`/help | atomicbot | تم الاشتراك ببوت البرميوم | Created By PITAR`,'https://www.twitch.tv/v5bz');
});
...
تاريخ انتهاء صلاحية البوت البرميوم : 25 /  06 /2018
...
client.on('message', message => {
    if(message.content.includes('discord.gg')){ 
        ...
        message.delete()
    return message.reply(`**ممنوع نشر اي رابط او انفايت داخل السيرفر :rage:**`)
    }
}
});
...
client.on('message' , message => {
 ...
 .setURL('https://discordapp.com/oauth2/authorize?client_id=427430301107617804&scope=bot&permissions=2146958591')
  message.channel.sendEmbed(embed);
   }
});
...
client.login('NDI3NDMwMzAxMTA3NjE3ODA0.DZkbCQ.am4BKMAhZi9JsvTPC0Fe6Hmp0H8');
